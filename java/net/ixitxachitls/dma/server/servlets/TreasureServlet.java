...
public class TreasureServlet extends PageServlet
{
  ...
  private static final List<Magic> MAGIC_WANDS = ImmutableList.of(
  );

  private static final List<Magic> MAGIC_WONDROUS_ITEMS = ImmutableList.of(
  );
  ...
  private static final List<Magic> MINOR = ImmutableList.of(
      ...
      new Magic(91, "Wand", MAGIC_WANDS),
      new Magic(100, "Wonrdous item", MAGIC_WONDROUS_ITEMS));
  ...
  private static final List<Magic> MEDIUM = ImmutableList.of(
      ...
      new Magic(40, "Ring", 0, 0, ImmutableList.of(
      ...
      new Magic(65, "Scroll", ImmutableList.of(
      ...
      new Magic(83, "Wand", MAGIC_WANDS),
      new Magic(100, "Wondrous item", MAGIC_WONDROUS_ITEMS));
  ...
  private static final List<Magic> MAJOR = ImmutableList.of(
      ...
      new Magic(35, "Ring", 0, 0, ImmutableList.of(
      ...
      new Magic(55, "Scroll", ImmutableList.of(
      ...
      new Magic(75, "Staff", 0, 0, ImmutableList.of(
